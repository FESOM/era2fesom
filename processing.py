...
var_list = ['tcc', 'skt', 'ci', 'q', 'u', 'v', 't2m', 'sp', 'tcc', 'ssrd', 'strd', 'strc', 'sf', 'rf']

if int(yyyy) > 2021 or int(yyyy) < 1979:
	print('Error: year out of range [1979,2021]')
	sys.exit(1)
...
if var == 'ssrd':
	...
	cdo.selyear(yyyy, input='-invertlat -setreftime,1900-01-01,00:00:00,1day -settaxis,' + yyyy + '-01-01,00:30:00,1hour -mergetime -seltimestep,8755/8760 ' + outfile_p2 + " " + outfile_p1, output=outfile, options='-f nc4 -b F32 -P 8' )     
	shutil.rmtree('/mnt/lustre01/work/ba1138/a270099/era5/forcing/tmp'+var+yyyy)
